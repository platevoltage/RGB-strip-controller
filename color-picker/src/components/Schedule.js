...
export default function Schedule({schedule, setSchedule, colors, currentTime, windowWidth}) {
    ...
    return (
        <div style={style} ref={selfRef}>
            <div ref={timelineRef} style={{position: 'absolute', right: "20px", top: "40%", width: "calc(100% - 250px)", height: "20px"}}>
                <ScheduleTimeline realTime={true} currentTime={currentTime} timelineRef={timelineRef}/>
